...
(function() {
  ...
  Ember.Handlebars.registerHelper('input-field', function(property, options) {
    ...
    var context = options.data.view.get('controller'),
      propertyType = function(property) {
        ...
        if (constructor.proto) {
          ...
          return descs ? descs[property] : undefined;
        } else {
          return null;
        }
      };
...
(function() {
  Ember.EasyForm.Button = Ember.EasyForm.BaseView.extend({
    tagName: 'button',
    template: Ember.Handlebars.template({
      "compiler": [6, ">= 2.0.0-beta.1"], "main": function(depth0, helpers, partials, data) {
        var stack1;
        stack1 = helpers._triageMustache.call(depth0, "text", {
